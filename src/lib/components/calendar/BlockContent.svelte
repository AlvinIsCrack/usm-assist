...
<div
	class="bg-background/20 ring-input h-full w-full rounded-lg ring will-change-transform ring-inset"
>
	...
	{:else}
		<div class="h-full w-full p-2">3 RAMOS EN CONFLICTO, ESTO NO ESTÁ IMPLEMENTADO AÚN.</div>
	{/if}
</div>
